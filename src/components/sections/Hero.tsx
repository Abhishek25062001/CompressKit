...
import { ArrowDown, ArrowLeftRight, Crop, FileText, Scissors } from 'lucide-react';
  ...
  return (
    <section id="top" className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-4xl px-4 pt-16 pb-12 text-center sm:px-6 sm:pt-24 sm:pb-16">
        ...
        >
          Reduce file sizes while preserving visual quality, convert between formats, crop photos to exact sizes, trim videos for WhatsApp Status, or build and split PDFs. Everything happens directly in your browser.
        </motion.p>
        <motion.div
          custom={3}
          variants={fadeUp}
